...
3.Acesse o phpMyAdmin e crie o banco lista_tarefas.
4.Importe o arquivo lista-bdd.sql para criar a tabela e os dados.
...
2.As tarefas serão salvas no navegador via LocalStorage.
